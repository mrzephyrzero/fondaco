...
| CI green on the skeleton | ✅ GitHub Actions run `success` on `8607613` (https://github.com/mrzephyrzero/fondaco/actions/runs/29280124802); also verified locally |
...
2. **Local Python** — dev machine has 3.13/3.11, not 3.12; CI and Docker pin 3.12 (frozen stack). Fine, or install 3.12 locally for exact parity?
